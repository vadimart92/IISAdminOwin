define(["require", "angular", "routes", "angularAMD", "jsFace", "ngResource", "ngAnimate", "ngSanitize", "ui_bootstrap", "ui_bootstrap_tpls", "ui_grid", "ui_select", "loading_bar", "ui_formly", "angular_formly_templates"], function(require, angular, routes, angularAMD) {
  var app;
